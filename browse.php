              ...
              <div class="top-downloaded">
                ...
                <ul>
                  <li>
                    ...
                    <div class="download">
                      <form action="lib/like.php" method="POST"><button name="like" value="1" ><a><i class="fa fa-download"></i></a></button></form>
                  ...
                  <li>
                    ...
                    <span><i class="fa fa-download" style="color: #ec6090;"></i> 2.2M</span>
                    <div class="download">
                    <form action="lib/like.php" method="POST"><button name="like" value="2" ><a><i class="fa fa-download"></i></a></button></form>
                    </div>
                  </li>
                  <li>
                    ...
                    <span><i class="fa fa-download" style="color: #ec6090;"></i> 2.2M</span>
                    <div class="download">
                    <form action="lib/like.php" method="POST"><button name="like" value="3" ><a><i class="fa fa-download"></i></a></button></form>
                    </div>
                  </li>
                </ul>
